...
def get_tray_stackable(thing, **kwargs):
    #return get_tray_stackable_angled_bottom(thing, **kwargs)
    return get_tray_stackable_sphere_bottom(thing, **kwargs)


def get_tray_stackable_sphere_bottom(thing, **kwargs):
...
def get_tray_stackable_angled_bottom(thing, **kwargs):
