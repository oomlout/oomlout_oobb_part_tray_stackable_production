...
difference() {
	union() {
		...
		translate(v = [-30.0000000000, -30.0000000000, 11]) {
			rotate(a = [0, 180, 0]) {
				hull() {
					union() {
		...
		translate(v = [-30.0000000000, 0.0000000000, 11]) {
			rotate(a = [0, 180, 0]) {
				hull() {
					union() {
						translate(v = [-10.0000000000, 10.0000000000, 5]) {
		...
		translate(v = [0.0000000000, -30.0000000000, 11]) {
			rotate(a = [0, 180, 0]) {
				hull() {
					union() {
						translate(v = [-10.0000000000, 10.0000000000, 5]) {
